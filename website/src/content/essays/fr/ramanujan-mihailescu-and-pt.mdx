...
Cet essai existe en deux versions sur cette même page. La version <strong>vulgarisée</strong> (sans formules au-delà de l’élémentaire) s’affiche au niveau de lecture <em>vulgarisé</em>. La version <strong>standard / technique</strong> (avec preuve d’unicité, références D17b, statut épistémique) s’affiche aux niveaux <em>standard</em> et <em>technique</em>. Utilisez le sélecteur de profondeur en bas à droite ↘ pour basculer.
</aside>
