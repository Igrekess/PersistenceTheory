...
Le nombre de générations est égal au **nombre de premiers actifs** au point fixe attractif $\mu^* = 15$. Ce nombre est 3, et **uniquement** 3 :
...
1. Un premier $p$ est actif si $\gamma_p > s = 1/2$ (critère BA4).
2. Au point fixe attractif $\mu^* = 15$, on calcule $\gamma_3 = 0{,}808$, $\gamma_5 = 0{,}696$, $\gamma_7 = 0{,}595$, $\gamma_{11} = 0{,}478$, ...
