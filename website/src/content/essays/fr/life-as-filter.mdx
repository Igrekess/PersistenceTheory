...
Cet essai existe en deux versions sur cette même page. La version <strong>vulgarisée</strong> (sans formules, métaphores explicites) s’affiche au niveau de lecture <em>vulgarisé</em>. La version <strong>standard / technique</strong> (signatures biologiques validées, extensions conjecturelles, statuts épistémiques) s’affiche aux niveaux <em>standard</em> et <em>technique</em>. Utilisez le sélecteur de profondeur en bas à droite ↘ pour basculer.
</aside>
