...
summary: 'L’espace n’a pas trois dimensions par hasard. La PT donne une raison arithmétique : il y a exactement trois nombres premiers actifs au point fixe — $\{3, 5, 7\}$ — et chacun ouvre une direction.'
level: L1
reading_minutes: 6
