...
summary: 'Space does not have three dimensions by accident. PT gives an arithmetic reason: there are exactly three active primes at the reduced attractor — $\{3, 5, 7\}$ — and each opens one direction.'
level: L1
reading_minutes: 6
...
Computing $\gamma_p$ at the reduced attractor $\mu^* = 15$:
...
The reduced attractor $\mu^* = 15$ is not a choice: it is the **only** subset of primes that satisfies the self-consistency condition in the information sector
...
> 🧮 **[→ γ_p(μ) calculator](/en/calculator)** — slide μ and watch the
> list of active primes change. At μ* = 15, exactly $\{3, 5, 7\}$ cross
> the threshold $\gamma_p > 1/2$.

## See also

- [Essay — Where s = 1/2 comes from](/en/essays/where-s-comes-from)
- [Essay — What is an echo prime?](/en/essays/echo-primes) — the fate of $\{11, 13\}$
- [Theorem T5 — Fixed point μ* = 15](/en/theorems/T5)
