...
The number of generations equals the **number of active primes** at the attractive fixed point $\mu^* = 15$. That number is 3, and **only** 3:
...
1. A prime $p$ is active if $\gamma_p > s = 1/2$ (BA4 criterion).
2. At the attractive fixed point $\mu^* = 15$: $\gamma_3 = 0.808$, $\gamma_5 = 0.696$, $\gamma_7 = 0.595$, $\gamma_{11} = 0.478$, ...
