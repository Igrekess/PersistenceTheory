...
All prime numbers, in fact, are positions where additive being and multiplicative having coincide — the property does not single out the first six among them. What PT adds is a selection criterion: the backbone {2, 3, 5, 7, 11, 13} is the set of primes the cascade keeps *active*, the ones the dynamics retains around the reduced attractor μ* = 15. Other primes still exist; the sieve neutralises them.
