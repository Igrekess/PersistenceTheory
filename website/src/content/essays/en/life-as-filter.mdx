...
In the [gravity essay](/en/essays/where-gravity-comes-from) we saw that *information* is what survives a filter. Now picture a sieve that doesn't sieve once but in a loop. Nothing crosses for good. Every second, every structure has to re-cross it to remain what it is.
