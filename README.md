...
| Goal | Where to go |
|---|---|
| **Read the monograph (English)** | [`TheTheoryOfPersistence.pdf`](TheTheoryOfPersistence.pdf) — 987 pages |
| **Lire la monographie (français)** | [`TheorieDeLaPersistance_FR.pdf`](TheorieDeLaPersistance_FR.pdf) — 1026 pages |
...
```text
.
├── TheTheoryOfPersistence.pdf       English monograph (987 pages)
├── TheorieDeLaPersistance_FR.pdf    French monograph (1026 pages)
├── README.md                        This file
